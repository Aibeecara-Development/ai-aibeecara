...
import epitran
from . import ModelInterfaces as mi
from . import RuleBasedModels
...
class PronunciationTrainer:
    ...
    def getWordLocationsFromRecordInSeconds(self, word_locations, mapped_words_indices) -> list:
        ...
        for word_idx in range(len(mapped_words_indices)):
            idx = mapped_words_indices[word_idx]
            if idx < len(word_locations):
                ...
                # Index out of range, append default value
